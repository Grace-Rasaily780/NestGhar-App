...
function Location({ margin, navi, location, img }) {
    return (
        <TouchableWithoutFeedback onPress={() => { navi.navigate('Room')}}>
        <View style={[styles.container, margin]}>
            ...
            <View style={styles.room_info}>
                <View style={{ flexDirection: 'row', justifyContent: 'center', textAlign: 'center', height: '100%', alignItems: 'center' }}>
                    <CustomText style={{ color: '#fff', fontSize: 14, fontWeight: '500', letterSpacing: 0.5, textAlign: 'center', textTransform: 'uppercase', }}>{location}</CustomText>
                </View>
