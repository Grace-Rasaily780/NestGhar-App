            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', height: '100%', paddingTop: 18, paddingBottom: 18 }}>
                ...
                <View style={{ flexDirection: 'column', width: '90%', alignItems: 'center'}}>
                    ...
                    <View style={styles.login_container}>
                        <CustomText style={{ fontSize: 19, marginBottom: 4 }}>Register</CustomText>
                        <CustomText style={{ fontSize: 12, color: '#B5B5B5' }}>Please Register to continue</CustomText>
                        ...
                        <View>
                            <View style={[styles.login_btn, { marginBottom: 8 }]}>
                                <CustomText style={{ textAlign: 'center', fontSize: 16, color: '#fff', fontWeight: 'bold' }}>Register</CustomText>
                            </View>
                        </View>

                        <View style={{ padding: '2%' }}>
                            <TouchableOpacity onPress={() => { navigation.navigate('Login'); } }>
                                <CustomText style={{ textAlign: 'center', color: '#22201F', fontSize: 14, fontWeight: '500' }}>Already have an account? <CustomText style={{ color: '#C49A6C', fontWeight: '500' }}>Login</CustomText></CustomText>
                            </TouchableOpacity>
                        </View>
                    </View>
                    {/* {
